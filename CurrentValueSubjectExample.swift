...
publisher.send(200) //Subscription1 prints 200 the updated value 200

//Second Subscriber
let subscription2 = publisher.sink { integer in
    print("integer2 is: \(integer)") //Subscription2 printss 200 the initial value at subscription point
}
